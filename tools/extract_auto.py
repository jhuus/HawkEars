...
if __name__ == '__main__':
    ...
    parser.add_argument('--mid_part', type=float, default=.8, help='Portion of center to consider when checking if centered (default = .8, i.e. middle 80 percent)')
    parser.add_argument('--mid_min', type=float, default=.8, help='Center portion must have this much of total sound to be considered centered (default = .8, i.e. at least 80 percent)')
