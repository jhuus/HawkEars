# Copied from https://github.com/THU-MIG/RepViT
...
class RepViT(nn.Module):
    def __init__(self, cfgs, num_classes=1000, distillation=False):
        ...
        # JH: changed 3 to 1 here (input channel count)
...
def get_model(model_name, **kwargs):
    if model_name == 'm1':
        return repvit_m1(**kwargs)
    elif model_name == 'm2':
        return repvit_m2(**kwargs)
    elif model_name == 'm3':
        return repvit_m3(**kwargs)
    else:
        raise Exception(f"Unknown custom RepViT model name: {model_name}")
